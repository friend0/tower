...
class trajectory_t(object):
    __slots__ = ["timestamp", "position", "orientation", "num_waypoints", "waypoints", "vehicle_name", "enabled"]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>%di' % self.num_waypoints, *self.waypoints[:self.num_waypoints]))
        __vehicle_name_encoded = self.vehicle_name.encode('utf-8')
        buf.write(struct.pack('>I', len(__vehicle_name_encoded)+1))
        buf.write(__vehicle_name_encoded)
        buf.write(b"\0")
    ...
    def _decode_one(buf):
        ...
        self.waypoints = struct.unpack('>%di' % self.num_waypoints, buf.read(self.num_waypoints * 4))
        __vehicle_name_len = struct.unpack('>I', buf.read(4))[0]
        self.vehicle_name = buf.read(__vehicle_name_len)[:-1].decode('utf-8', 'replace')
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xf6e1986c762aa65f) & 0xffffffffffffffff
