...
sys.path.insert(0, os.path.abspath('..'))
# sys.path.insert(0, os.path.abspath('../world_engine/docs/img/'))
...
MOCK_MODULES = ['rasterio', 'numpy', 'pynmea', 'osgeo', 'matplotlib', 'matplotlib.pyplot', 'geographiclib', 'geographiclib.geodesic']
